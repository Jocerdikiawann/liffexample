window.onload = function () {
  ...
  const defaultLiffId = "1655319591-bMJO8BYm"; // change the default LIFF value if you are not using a node server
...
function registerButtonHandlers() {
  document
    ...
    .addEventListener("click", function () {
      liff.openWindow({
        url: "https://exliff.herokuapp.com/", // Isi dengan Endpoint URL aplikasi web Anda
        external: true,
      });
    });
